...
class App extends Component {
  ...
  formSubmit = (token) => {
    const tokenUser = {};
    this.showNotification("Please wait...");
      ...
      dashboardPageDiv = (
        <div className="dashboardPageDiv">
          ...
          <div className="createPostDiv">
            Click here to add post <i class="fas fa-arrow-right"></i>
            <input id='search-btn' type='checkbox' />

            <label for='search-btn'
              // className="createPostButton"
              onClick={this.createPost}>Show search bar
            </label>

            <input id='search-bar' type='text' placeholder='What`s on your mind?'
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#273036" fill-opacity="1" d="M0,128L48,138.7C96,149,192,171,288,165.3C384,160,480,128,576,101.3C672,75,768,53,864,37.3C960,21,1056,11,1152,21.3C1248,32,1344,64,1392,80L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
        </div>
      );
    }
